...
def render_map(wiki_root: Path, topic: str, folder_data: dict[str, list[dict]], root_entries: list[dict]) -> str:
    ...
    lines.extend([
        ...
        "- `/wiki-cycle` — the research cycle: gather, triage, ingest, lint, report (`--full` adds the deeper passes)",
        "- `/wiki-search \"<query>\"` — find what the wiki says",
        "- `/wrap-up` — end of a session: file what it decided and learned",
        "",
        "The full list and how they fit together: the user guide, `how-to/llm-wiki/user-guide.md` beside `wiki/`.",
        "",
