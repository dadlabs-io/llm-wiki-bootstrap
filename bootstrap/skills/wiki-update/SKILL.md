...
```bash
python {{WIKI_SCRIPTS_DIR}}/wiki-qmd-query.py --notebook <topic> "<term>"     # full search, this notebook only, 10 results, two GPU slots; workers add --caller wiki-ingester
```
