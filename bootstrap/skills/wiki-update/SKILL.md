...
```bash
python {{WIKI_SCRIPTS_DIR}}/wiki-qmd-query.py --notebook <topic> "<term>"     # full search, this notebook only, 20 results, C sized to it, two GPU slots; workers add --caller wiki-ingester
```
