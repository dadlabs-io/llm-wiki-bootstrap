...
Steps 0 and 0.5 run on **every** wrap-up. Steps 1–6 depend on what the session produced.
...
If the notebook repo has unrelated uncommitted changes, add only the paths you wrapped. Don't push — that's the user's call.
