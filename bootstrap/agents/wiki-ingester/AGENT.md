...
3. **Search the wiki** for related entries — integrate, don't isolate. 3–5 key terms, each with
   ...
   (keyword + meaning + rerank on the GPU; `-k` results, default 10; `-C` candidates the reranker scores, default 40). Always pass the
